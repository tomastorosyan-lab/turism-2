...
export type BlogPost = {
  ...
  content: string[];
  tags: string[];
  /** Обложка статьи (локальные фото курортов в /public/images/resorts). */
  coverImage: string;
  coverImageAlt: string;
};
...
export const blogPosts: BlogPost[] = [
  {
    ...
    coverImage: "/images/resorts/new-afon.jpg",
    coverImageAlt:
      "Новый Афон, Абхазия: природа и достопримечательности — планирование поездки по сезону",
    content: [
  ...
  },
  {
    ...
    coverImage: "/images/resorts/gagra.jpg",
    coverImageAlt:
      "Гагра, Абхазия: историческая застройка и субтропический парк — про атмосферу курортных отелей",
    content: [
  ...
  },
  {
    ...
    coverImage: "/images/resorts/sukhum.jpg",
    coverImageAlt:
      "Сухум, Абхазия: столица у моря — прозрачные условия и сравнение предложений",
    content: [
